...
namespace TPIntegrador_PWeb3.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public ActionResult login(FormCollection form)
        {
            ...
            else if (usuario.Email == Email &&  usuario.Activo == true)
            {
            ...
            else if (usuario.Email == Email && Helper.SessionHelper.IdNecesidad != null && usuario.Activo == true)
            {
        ...
        public ActionResult denunciar()
        {
            ...
            violacionDerechos.Descripcion = "Violaciòn de derechos";
            MotivoDenuncia politica = new MotivoDenuncia();
            politica.Descripcion = "Contiene informacion politica";
